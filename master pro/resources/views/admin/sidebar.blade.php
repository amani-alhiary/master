                ...
                <div class="left_col scroll-view">
                    ...
                    <ul class="nav child_menu">
                      ...
                      <li><a href="calendar.html">Calendar</a></li> --}}
                                ...
                                <li><a><i class="fa fa-bar-chart-o"></i> Comments <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                ...
                                <li><a><i class="fa fa-clone"></i>Used Books <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
